<template>
  ...
  <swiper
    ...
    :loop="true"
  >
    <swiper-slide class="swiper-banner swiper-banner-img1"></swiper-slide>
    <swiper-slide class="swiper-banner swiper-banner-img2"></swiper-slide>
    <swiper-slide class="swiper-banner swiper-banner-img3"></swiper-slide>
  </swiper>
</template>
<script>
