<template>
    <div class="modal fade" ref="signOutUser" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="signOutUserLabel" aria-hidden="true">
...
export default {
  ...
  mounted() {
    this.Modal = new Modal(this.$refs.signOutUser);
  },
};
</script>
