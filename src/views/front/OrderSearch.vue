<template>
  ...
  <div class="container mt-5">
    <button type="button" class="btn btn-secondary"
     @click="$router.push('/orders')"> 返回訂單頁面</button>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text   d-flex justify-content-between align-items-center">
              ...
              <small class="m-0 fz-md-1">{{ $toLocaleDate(orderData.order.create_at) }}</small>
            </p>
            <span class="card-text d-flex justify-content-between align-items-center">
              <p class="m-0 ">備註: </p>
              <p v-if="orderData.order.message.split('//splitValue//')[0] !== ' '" class="m-0 ">
              {{ orderData.order.message.split('//splitValue//')[0] }}</p>
